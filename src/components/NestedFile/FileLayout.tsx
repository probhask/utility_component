        ...
        <>
          ...
          <div className={styles["root-file"]}>
            ...
            <div className={styles["action-buttons"]}>
              <span onClick={() => onActionBtnClick("file")} title="addFileBtn">
                <FiFilePlus />
              </span>
              <span
                onClick={() => onActionBtnClick("folder")}
                title="addFolderBtn"
              >
                <FiFolderPlus />
              </span>
              <span onClick={handleCollapseAll} title="collapseAllBtn">
                <VscCollapseAll />
              </span>
            </div>
          </div>
